...
export default function Layout() {
  ...
  if (user?.rol === 'administrador') {
    navItems.push({ path: '/explorador', label: 'Navegador de Archivos', icon: <IconFolder /> });
  ...
  const pageInfo: Record<string, { title: string; subtitle: string }> = {
    ...
    '/explorador': { title: 'Navegador de Archivos', subtitle: 'Explora expedientes jerárquicamente' },
